    ...
    return (
        <header className={classes}>
            ...
            <div className={styles.searchWrapper}>
                ...
                <input disabled={hasError || isLoading} className={`${styles.search} focus-visible:border-ring focus-visible:ring-ring/50 shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px]`} placeholder='Search by Name, Region, Subregion' onChange={(e) => updateSearchTerm && updateSearchTerm(e.target.value)} type='search' />
            </div>
        </header>
    )
}
